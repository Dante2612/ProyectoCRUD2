...
public class EditarReporte extends javax.swing.JFrame {

    Controladora control = null;
    int códigoJugadorRep;
    Reporte rep;
    
    public EditarReporte(int códigoJugadorRep) {
        control = new Controladora();
        initComponents();
        cargarReporte(códigoJugadorRep);
    ...
    private void initComponents() {
        ...
        btn_guardarCambios = new javax.swing.JToggleButton();
        btn_limpiar = new javax.swing.JToggleButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jTextField1.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
        jTextField1.setText("Editar Reporte de Jugador");
        ...
        btn_guardarCambios.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(296, 296, 296)
                .addComponent(btn_guardarCambios, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btn_guardarCambios, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_guardarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarCambiosActionPerformed
        ...
        control.guardarCambios(rep, idjugador, celular, correo, servidor, idjugadorReportado, fecha, motivo, observación);
    ...
    private javax.swing.JToggleButton btn_guardarCambios;
    ...
    private void cargarReporte(int códigoJugadorRep) {

        this.rep = control.traerReporte(códigoJugadorRep);

        txt_idJugador.setText(rep.getEljugador().getIdJugador());
        txt_celular.setText(rep.getEljugador().getCelular());
        txt_correoElectrónico.setText(rep.getEljugador().getCorreoElectrónico());
        if (rep.getEljugador().getServidor().equals("EU")) {
            cmb_servidor.setSelectedIndex(1);
        } else {
            if (rep.getEljugador().getServidor().equals("NA")) {
                cmb_servidor.setSelectedIndex(2);
            } else {
                if (rep.getEljugador().getServidor().equals("LAN")) {
                    cmb_servidor.setSelectedIndex(3);
                } else {
                    if (rep.getEljugador().getServidor().equals("LAS")) {
                        cmb_servidor.setSelectedIndex(4);
                    } else {
                    }
                }
            }
        ...
        txt_idJugadorReportado.setText(rep.getIdJugadorRep());
        txt_fecha.setText(rep.getFecha());
        if (rep.getMotivo().equals("Actitud Negativa")) {
            cmb_motivo.setSelectedIndex(1);
        } else {
            if (rep.getMotivo().equals("Abuso Verbal")) {
                cmb_motivo.setSelectedIndex(2);
            } else {
                if (rep.getMotivo().equals("Inactividad (AFK)")) {
                    cmb_motivo.setSelectedIndex(3);
                } else {
                    if (rep.getMotivo().equals("Trampas")) {
                        cmb_motivo.setSelectedIndex(4);
                    } else {
                    }
                }
            }
        }
        txt_observación.setText(rep.getObservación());
